...
> Note: local test collection currently fails when optional deps (structlog, imblearn, lightgbm) are missing — install full requirements before running (see Tracker.md BLK-001).
